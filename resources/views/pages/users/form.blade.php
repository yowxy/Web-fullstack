            ...
            <div class="row">
                <div class="col-12 col-lg-5">
                    <form action="">
                        <div class="d-flex flex-column flex-md-row mb-4 " >
                            <div class="edit-avatar-wrapper mb-3 mb-md-0 mx-auto mx-md-0 ">
                                <div class="avatar-wrapper rounded-circle  overflow-hidden  flex-shrink-0 me-4">
                                    <img  id="avatar" src="{{ url('assets/images/Ellipse 4.png') }}" alt="" class="avatar" >
                                </div>
                        ...
                        <div>
                            <button class="btn-primary me-2" tabindex="submit" >Save</button>
                            <a href="" class="text-decoration-none text-black" >Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
